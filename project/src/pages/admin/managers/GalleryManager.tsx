            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Upload {editingItem.type === 'image' ? 'Image' : 'File'}
                </label>
                <div className="flex items-center gap-3">
                  <label className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary-500 cursor-pointer transition bg-gray-50">
                    ...
                    <input
                      type="file"
                      accept={editingItem.type === 'image' ? 'image/*' : '*'}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Or enter {editingItem.type === 'image' ? 'Image' : 'Video'} URL
                </label>
                <input
                  type="url"
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  placeholder={editingItem.type === 'video' ? 'https://drive.google.com/file/d/...' : 'https://example.com/image.jpg'}
                />
                {editingItem.type === 'video' ? (
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    You can also paste image URLs from Pexels or other sources
                  </p>
                )}
              </div>
