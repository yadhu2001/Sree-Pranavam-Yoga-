  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => {
            setEditingCourse({ is_published: true });
            setIsEditing(true);
            setImageFile(null);
            setImagePreview('');
          }}
                  ...
                  <tr key={course.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-600 space-y-1">
                        {course.level && <div>Level: <span className="capitalize">{course.level}</span></div>}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-white rounded-lg p-6 max-w-3xl w-full my-8">
            ...
            <div className="space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {(imagePreview || editingCourse.image_url) && (
                    <img
                      src={imagePreview || editingCourse.image_url || ''}
                      alt="Preview"
                      className="w-full h-48 object-cover rounded-lg"
                    />
                  )}
                  <div className="flex gap-3">
                    <label className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-primary-500 transition">
                  ...
                  <input
                    type="url"
                    value={imageFile ? '' : (editingCourse.image_url || '')}
                    onChange={(e) => {
                  ...
                  <p className="text-xs text-gray-500">
                    Upload an image from your computer or paste a URL from Pexels or other sources
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setEditingCourse({ ...editingCourse, eligibility_criteria: e.target.value })}
                  rows={3}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setEditingCourse({ ...editingCourse, certification_scope: e.target.value })}
                  rows={3}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            ...
            <div className="flex justify-end gap-3 mt-6 pt-6 border-t">
              ...
              <button
                onClick={handleSave}
                disabled={uploading || !editingCourse.title || !editingCourse.description}
