...
import { Plus, Edit2, Trash2, Save, X, Eye, EyeOff, GripVertical, Upload } from 'lucide-react';
...
export default function AboutUsManager() {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>, type: 'section' | 'settings') => {
    ...
    try {
      ...
      if (type === 'section') {
        ...
        setEditingSettings({ ...editingSettings, hero_image_url: publicUrl });
      }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary-500 cursor-pointer transition bg-gray-50">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <RichTextEditor
                      ...
                      onChange={(value) => setEditingSettings({ ...editingSettings, mission: value })}
                  ...
                  <div>
                    ...
                    <RichTextEditor
                      ...
                      onChange={(value) => setEditingSettings({ ...editingSettings, core_values: value })}
