      ...
      {settings?.vision && (
        <section className="py-16 bg-gradient-to-br from-primary-50 to-primary-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              className="prose prose-lg prose-primary max-w-none text-gray-700 text-center"
      ...
      {settings?.mission && (
        <section className="py-16 bg-gradient-to-br from-blue-50 to-cyan-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              className="prose prose-lg prose-blue max-w-none text-gray-700 text-center"
      ...
      {settings?.core_values && (
        <section className="py-16 bg-gradient-to-br from-amber-50 to-orange-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              className="prose prose-lg prose-amber max-w-none text-gray-700 text-center"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {locations.map((location) => (
                <div key={location.id} className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition">
