        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto space-y-8">
            <section>
              ...
              <p className="text-lg text-gray-700 leading-relaxed whitespace-pre-wrap">{course.description}</p>
            </section>

            {(course.course_duration || course.level || course.eligibility_criteria || course.age_limit || course.fees || course.certification_scope) && (
