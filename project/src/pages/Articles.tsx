...
export default function Articles({ onNavigate }: ArticlesProps) {
  ...
  const loadArticles = async () => {
    ...
    if (featuredData.data) setFeatured(featuredData.data);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article) => (
            <div key={article.id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition">
